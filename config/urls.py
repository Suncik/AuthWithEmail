...
from rest_framework import permissions # in schema_view
from drf_yasg import openapi # for swagger 
from drf_yasg.views import get_schema_view # for swagger 
from django.views.generic import TemplateView    # for froontend

schema_view = get_schema_view(   # for swagger   
   openapi.Info(
      title="Auth API",
      default_version='v1',
